...
```bash
dart .agent/skills/aggregate_translations/scripts/aggregate.dart [output_directory]
```
...
```bash
dart .agent/skills/aggregate_translations/scripts/aggregate.dart
```

**Output to a custom directory:**
```bash
dart .agent/skills/aggregate_translations/scripts/aggregate.dart assets/aggregated_locales
```
