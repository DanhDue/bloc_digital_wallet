...
3. IMPLEMENT: After confirmation, create:
   - Domain Layer:
     - Entity: notification_entity.dart (@freezed with abstract class and @JsonKey)
   ...
   - Data Layer:
     - Model: notification_model.dart (@freezed with abstract class and @JsonKey)
...
[x] Implement NotificationEntity with @freezed, abstract class, and @JsonKey
