...
///   /// Get all items
///   Future<Either<Failure, List<TrendsEntity>>> getAll();
///
///   /// Get item by ID
///   Future<Either<Failure, TrendsEntity>> getById(String id);
///
///   /// Create new item
///   Future<Either<Failure, TrendsEntity>> create(TrendsEntity entity);
///
///   /// Update existing item
///   Future<Either<Failure, TrendsEntity>> update(TrendsEntity entity);
///
///   /// Delete item
