...
///
///   /// Get item by ID
///   Future<Either<Failure, OnboardEntity>> getById(String id);
///
///   /// Create new item
///   Future<Either<Failure, OnboardEntity>> create(OnboardEntity entity);
///
///   /// Update existing item
///   Future<Either<Failure, OnboardEntity>> update(OnboardEntity entity);
///
///   /// Delete item
