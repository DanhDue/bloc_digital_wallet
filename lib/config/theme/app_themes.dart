...
class AppThemes extends ThemeExtension<AppThemes> with _$AppThemesTailorMixin {
  ...
  AppThemes lerp(ThemeExtension<AppThemes> other, double t) {
    ...
    return AppThemes(
      ...
      authTextSecondary:
          Color.lerp(authTextSecondary, other.authTextSecondary, t) ??
          authTextSecondary,
      authBorderColor:
          Color.lerp(authBorderColor, other.authBorderColor, t) ??
          authBorderColor,
      authShadowColor:
          Color.lerp(authShadowColor, other.authShadowColor, t) ??
          authShadowColor,
      authTextPrimary:
          Color.lerp(authTextPrimary, other.authTextPrimary, t) ??
          authTextPrimary,
      displayLarge:
