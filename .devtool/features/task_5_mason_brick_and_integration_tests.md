...
- [ ] `pac_mvi_feature` scaffolds a new feature that is immediately reachable via deep link.
- [ ] Integration test passes cleanly.
- [ ] No regression in existing test suites across the monorepo.
