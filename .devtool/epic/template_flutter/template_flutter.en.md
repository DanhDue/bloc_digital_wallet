...
- Trim `.agents/`, `.devtool/epic/`, `docs/`, and multi-IDE config to a lean, generic set.
...
| 5 | [Docs & `.agents` cleanup](../../features/task_5_docs_agent_cleanup.md) | Scrub project-name references, trim `.devtool/epic`/`docs/`, consolidate multi-IDE config. |
