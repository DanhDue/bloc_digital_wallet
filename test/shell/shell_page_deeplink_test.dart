...
void main() {
  ...
  testWidgets('ShellPage triggers onRouterReady after first frame', (tester) async {
    await ThemeManager.instance.init();
    await getIt<AppInitializer>().init();

    var isRouterReadyCalled = false;
    ...
    expect(isRouterReadyCalled, isTrue);
  });
}
