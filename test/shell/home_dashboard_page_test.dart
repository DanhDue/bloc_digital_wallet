...
void main() {
  group('HomeDashboardPage Tests', () {
    testWidgets('HomeDashboardPage does NOT wrap content in a nested Scaffold', (tester) async {
    ...
    testWidgets('HomeDashboardPage renders header, icon, and description texts', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          theme: ThemeData(extensions: [AppThemes.light]),
          home: const Scaffold(body: HomeDashboardPage()),
