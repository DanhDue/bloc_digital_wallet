...
data class NativeLogMessage (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): NativeLogMessage {
      ...
      val traceId = pigeonVar_list[4] as String?
      return NativeLogMessage(level, tag, message, timestamp, traceId)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as NativeLogMessage
    return MessagesPigeonUtils.deepEquals(this.level, other.level) && MessagesPigeonUtils.deepEquals(this.tag, other.tag) && MessagesPigeonUtils.deepEquals(this.message, other.message) && MessagesPigeonUtils.deepEquals(this.timestamp, other.timestamp) && MessagesPigeonUtils.deepEquals(this.traceId, other.traceId)
  }
  ...
  override fun hashCode(): Int {
    ...
    result = 31 * result + MessagesPigeonUtils.deepHash(this.traceId)
    return result
  }
}
...
class NativeLogFlutterApi(private val binaryMessenger: BinaryMessenger, private val messageChannelSuffix: String = "") {
  ...
  fun onNativeLog(messageArg: NativeLogMessage, callback: (Result<Unit>) -> Unit)
{
    val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
    val channelName = "dev.flutter.pigeon.logger_native_bridge.NativeLogFlutterApi.onNativeLog$separatedMessageChannelSuffix"
 ...
 */
interface NativeLogHostApi {
  fun triggerFlush()

  companion object {
    /** The codec used by NativeLogHostApi. */
    val codec: MessageCodec<Any?> by lazy {
      MessagesPigeonCodec()
    }
    /** Sets up an instance of `NativeLogHostApi` to handle messages through the `binaryMessenger`. */
    @JvmOverloads
    fun setUp(binaryMessenger: BinaryMessenger, api: NativeLogHostApi?, messageChannelSuffix: String = "") {
      val separatedMessageChannelSuffix = if (messageChannelSuffix.isNotEmpty()) ".$messageChannelSuffix" else ""
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.logger_native_bridge.NativeLogHostApi.triggerFlush$separatedMessageChannelSuffix", codec)
        if (api != null) {
