...
void main() {
  testWidgets('LanguagePickerBottomSheet renders native language names and checkmark', (
    tester,
  ) async {
    String? selected;
  ...
  test('resolveNativeLanguageName maps known codes to native names', () {
    expect(
      LanguagePickerBottomSheet.resolveNativeLanguageName('en', 'Fallback'),
      equals('English'),
    );
    expect(
      LanguagePickerBottomSheet.resolveNativeLanguageName('vi', 'Fallback'),
      equals('Tiếng Việt'),
    );
    ...
    expect(
      LanguagePickerBottomSheet.resolveNativeLanguageName('fr', 'Fallback'),
      equals('Français'),
    );
    expect(
      LanguagePickerBottomSheet.resolveNativeLanguageName('de', 'Fallback'),
      equals('Deutsch'),
    );
    expect(
      LanguagePickerBottomSheet.resolveNativeLanguageName('es', 'Spanish'),
      equals('Spanish'),
    );
  });
}
