#!/usr/bin/env python3
"""
.agents/.tests/run_tests.py
Auto-discover and run all test_*.py files for a given skill.

Usage:
  python3 .agents/.tests/run_tests.py mobile-uiux-promax
...
ROOT = Path(__file__).resolve().parent  # .agents/.tests/


def run_suite(skill_name: str) -> tuple[int, int]:
    """Run all test_*.py in .agents/.tests/<skill_name>/. Returns (passed_files, failed_files)."""
