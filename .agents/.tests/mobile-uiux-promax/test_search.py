...
# Project root: 3 levels up (.agents/.tests/<skill>/test_*.py → project root)
BASE = str(Path(__file__).resolve().parents[3])
SCRIPT = f"{BASE}/.agents/.shared/mobile-uiux-promax/scripts/mobile-search.py"
DATA_DIR = f"{BASE}/.agents/.shared/mobile-uiux-promax/data"
